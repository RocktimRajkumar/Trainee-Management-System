...
<head>
    <meta charset="UTF-8">
    <title>PGDAEM | Upload Material</title>
...
<div class="a1-container a1-small a1-padding-32" style="margin-top:4%; margin-bottom:2px;">
       ...
       <form id="form1" name="form1" method="post" class="a1-container" action="savepgdaemmaterial.php" enctype="multipart/form-data">
        ...
        <tr>
            ...
            <td  height="35"><select name="state" id="boxxe">
