...
<?php 
$id=$_GET['id'];
		$sql="Select * from regional o Where o.sn=$id";
...
<div class="a1-container a1-small a1-padding-32" style="margin-top:2px; margin-bottom:2px;">
       ...
       <form id="form1" name="form1" method="post" class="a1-container" action="saveregional.php">
...
<td height="35">PROGRAM TYPE:</td><input type="hidden" name="pass" value=<?php echo $id; ?>/>
           	   <td height="35"><input name="pname" id="boxxe" type="text" value="REGIONAL WORKSHOP" size="30" readonly></td>
         	   </tr>
